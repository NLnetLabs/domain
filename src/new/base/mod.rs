...
pub mod compat {
    ...
    #[deprecated = "use 'crate::new::base::Header' instead."]
    pub use header::HeaderSection;

    #[deprecated = "use 'crate::new::base::SectionCounts' instead."]
    pub use header::HeaderCounts;

    #[deprecated = "use 'crate::new::base::RType' instead."]
    pub use iana::rtype::Rtype;

    #[deprecated = "use 'crate::new::base::name::Label' instead."]
    pub use name::Label;

    #[deprecated = "use 'crate::new::base::name::Name' instead."]
    pub use name::Name;

    #[deprecated = "use 'crate::new::base::Question' instead."]
    pub use question::Question;

    #[deprecated = "use 'crate::new::base::ParseRecordData' instead."]
    pub use rdata::ParseRecordData;

    #[deprecated = "use 'crate::new::rdata::UnknownRecordData' instead."]
    pub use rdata::UnknownRecordData;

    #[deprecated = "use 'crate::new::base::Record' instead."]
    ...
    pub mod header {
        #[deprecated = "use 'crate::new::base::HeaderFlags' instead."]
        pub use crate::new::base::HeaderFlags as Flags;

        #[deprecated = "use 'crate::new::base::Header' instead."]
        pub use crate::new::base::Header as HeaderSection;

        #[deprecated = "use 'crate::new::base::SectionCounts' instead."]
        pub use crate::new::base::SectionCounts as HeaderCounts;
    }

    pub mod iana {
        #[deprecated = "use 'crate::new::base::RClass' instead."]
        pub use class::Class;
        ...
        #[deprecated = "use 'crate::new::rdata::SecAlg' instead."]
        pub use secalg::SecAlg;

        pub mod class {
            #[deprecated = "use 'crate::new::base::RClass' instead."]
            pub use crate::new::base::RClass as Class;
        }

        pub mod digestalg {
            #[deprecated = "use 'crate::new::rdata::DigestType' instead."]
            pub use crate::new::rdata::DigestType as DigestAlg;
        }
        ...
        pub mod opt {
            #[deprecated = "use 'crate::new::edns::OptionCode' instead."]
            pub use crate::new::edns::OptionCode;
        }
        ...
        pub mod rtype {
            #[deprecated = "use 'crate::new::base::RType' instead."]
            pub use crate::new::base::RType as Rtype;
        }

        pub mod secalg {
            #[deprecated = "use 'crate::new::rdata::SecAlg' instead."]
            pub use crate::new::rdata::SecAlg;
        }
    }

    pub mod name {
        #[deprecated = "use 'crate::new::base::name::Label' instead."]
        pub use crate::new::base::name::Label;

        #[deprecated = "use 'crate::new::base::name::Name' instead."]
        pub use crate::new::base::name::Name;
    }

    pub mod question {
        #[deprecated = "use 'crate::new::base::Question' instead."]
        pub use crate::new::base::Question;
    }

    pub mod rdata {
        #[deprecated = "use 'crate::new::base::ParseRecordData' instead."]
        pub use crate::new::base::ParseRecordData;

        #[deprecated = "use 'crate::new::rdata::UnknownRecordData' instead."]
        pub use crate::new::rdata::UnknownRecordData;
    }

    pub mod record {
        #[deprecated = "use 'crate::new::base::Record' instead."]
        pub use crate::new::base::Record;
