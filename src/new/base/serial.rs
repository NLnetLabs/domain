...
/// Ordering of the [`SoaSerial`].
///
/// Comparison is forwarded to the underlying [`SeqNumberU32`].
///
/// Trait [`Ord`] is not implemented because not for all comparisons there is
/// a defined ordering.
///
/// For further details see [`SeqNumberU32::partial_cmp()`].
...
impl PartialOrd for SeqNumberU32 {
    ...
    /// numbers is limited to less than [`i32::MAX`]. If two numbers are
    /// exactly [`i32::MAX`] apart the order is undefined.
    ///
    /// [Section 3.2 of RFC1982]:
    /// https://datatracker.ietf.org/doc/html/rfc1982#section-3.2
    /// ```
    /// # use domain::new::base::SeqNumberU32;
